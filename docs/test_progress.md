...
| 图腾流派 | 单位数量 | 已测试 | 测试覆盖率 |
|----------|----------|--------|------------|
| 牛图腾 (cow_totem) | 9 | 9 | 100% |
| 蝙蝠图腾 (bat_totem) | 5 | 5 | 100% |
| 蝴蝶图腾 (butterfly_totem) | 6 | 5 | 83% |
| 狼图腾 (wolf_totem) | 7 | 7 | 100% |
| 眼镜蛇图腾 (viper_totem) | 8 | 8 | 100% |
| 鹰图腾 (eagle_totem) | 12 | 12 | 100% |
| **总计** | **47** | **46** | **98%** |

> **更新日期**: 2026-02-21
> **状态**: 46/47 测试任务已完成，1个任务 (TEST-BUTTERFLY-eel) 提交失败需重新提交
