...
|------|------|----------|----------|----------|----------|------|
| yak_guardian (牦牛守护) | 守护领域：周围友方减伤5%/10%/15% | ⬜ | ⬜ | ⬜ | ⬜ | ⏳ 待测试 |
| mushroom_healer (菌菇治愈者) | 过量转化：核心溢出治疗转为延迟回血 | ⬜ | ⬜ | ⬜ | ⬜ | ⏳ 待测试 |
| rock_armor_cow (岩甲牛) | 岩盾再生：脱战后生成护盾 | ⬜ | ⬜ | ⬜ | ⬜ | ⏳ 待测试 |
| cow_golem (牛魔像) | 震荡反击：受击15/12/10次后全屏眩晕 | ⬜ | ⬜ | ⬜ | ⬜ | ⏳ 待测试 |

**测试重点**：
- yak_guardian: 验证周围友方单位受击时减伤数值
- mushroom_healer: 模拟核心满血时治疗，验证延迟回血机制
- rock_armor_cow: 脱战后护盾生成，受击时护盾吸收
- cow_golem: 受击计数，达到阈值时全屏眩晕触发
...
| 单位 | 机制 | 放置测试 | 攻击测试 | 受击测试 | 实战测试 | 状态 |
|------|------|----------|----------|----------|----------|------|
| lure_snake (诱捕蛇) | 陷阱诱导：敌人触发陷阱后被牵引 | ⬜ | ⬜ | ⬜ | ⬜ | ⏳ 待测试 |
| medusa (美杜莎) | 石化凝视：周期石化最近敌人 | ⬜ | ⬜ | ⬜ | ⬜ | ⏳ 待测试 |

**测试重点**：
- lure_snake: 放置陷阱，让敌人触发，验证牵引效果和L3眩晕
- medusa: 验证石化周期、持续时间、L2/L3结束时的范围伤害
...
| 流派 | 单位数 | 负责人 | 状态 | 任务目录 |
|------|--------|--------|------|----------|
| 牛图腾 (4单位) | SubAgent-Cow | ⏳ 待开始 | tasks/cow_totem_units/ |
| 蝙蝠图腾 (4单位) | SubAgent-Bat | ✅ 已完成 | tasks/bat_totem_units/ |
| 眼镜蛇图腾 (2单位) | SubAgent-Cobra | ⏳ 待开始 | tasks/cobra_totem_units/ |
