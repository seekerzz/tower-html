...
const UNIT_TYPES = {
	"mouse": { "name": "加特林鼠", "icon": "🐭", "cost": 15, "size": Vector2i(1,1), "damage": 30, "range": 250, "atkSpeed": 0.15, "foodCost": 15, "manaCost": 0, "attackType": "ranged", "proj": "dot", "desc": "远程:超快攻速", "damageType": "physical", "hp": 100, "crit_rate": 0.1, "crit_dmg": 1.5 },
	"turtle": { "name": "狙击龟", "icon": "🐢", "cost": 25, "size": Vector2i(1,1), "damage": 450, "range": 500, "atkSpeed": 1.8, "foodCost": 80, "manaCost": 0, "attackType": "ranged", "proj": "rocket", "desc": "远程:超远单发", "damageType": "physical", "hp": 150, "crit_rate": 0.1, "crit_dmg": 1.5 },
	"ranger": { "name": "游侠", "icon": "🤠", "cost": 60, "size": Vector2i(1,1), "damage": 120, "range": 180, "atkSpeed": 1.5, "foodCost": 30, "manaCost": 0, "attackType": "ranged", "proj": "pellet", "projCount": 5, "spread": 0.5, "desc": "霰弹:扇形5发", "damageType": "physical", "hp": 150, "crit_rate": 0.1, "crit_dmg": 1.5 },
	"ninja": { "name": "忍者", "icon": "🥷", "cost": 80, "size": Vector2i(1,1), "damage": 250, "range": 250, "atkSpeed": 0.8, "foodCost": 40, "manaCost": 0, "attackType": "ranged", "proj": "shuriken", "pierce": 3, "desc": "直线穿透3敌", "damageType": "physical", "hp": 180, "crit_rate": 0.2, "crit_dmg": 1.5 },
	"tesla": { "name": "磁暴线圈", "icon": "⚡", "cost": 70, "size": Vector2i(1,1), "damage": 350, "range": 200, "atkSpeed": 1.2, "foodCost": 50, "manaCost": 50, "attackType": "ranged", "proj": "lightning", "chain": 4, "desc": "攻击产生闪电链", "damageType": "lightning", "hp": 200, "crit_rate": 0.1, "crit_dmg": 1.5 },
	"cannon": { "name": "震荡炮", "icon": "💣", "cost": 90, "size": Vector2i(1,1), "damage": 400, "range": 200, "atkSpeed": 2.0, "foodCost": 80, "manaCost": 0, "attackType": "ranged", "proj": "swarm_wave", "desc": "发射腐臭蜂群", "damageType": "poison", "hp": 200, "crit_rate": 0.1, "crit_dmg": 1.5 },
	"void": { "name": "奇点", "icon": "🌌", "cost": 200, "size": Vector2i(1,1), "damage": 50, "range": 300, "atkSpeed": 3.0, "foodCost": 150, "manaCost": 200, "attackType": "ranged", "proj": "black_hole", "desc": "发射黑洞(停留吸引)", "damageType": "magic", "hp": 250, "crit_rate": 0.1, "crit_dmg": 1.5 },
	"knight": { "name": "狂战士", "icon": "🗡️", "cost": 30, "size": Vector2i(1,1), "damage": 200, "range": 100, "atkSpeed": 0.8, "foodCost": 40, "manaCost": 0, "attackType": "melee", "splash": 60, "skill": "rage", "skillCd": 10, "desc": "近战:范围挥砍\n技能:血怒(300💧)", "damageType": "physical", "hp": 300, "crit_rate": 0.1, "crit_dmg": 1.5 },
	...
	"treant": { "name": "树人守卫", "icon": "🌳", "cost": 40, "size": Vector2i(1,1), "damage": 100, "range": 80, "atkSpeed": 1.5, "foodCost": 20, "manaCost": 0, "attackType": "melee", "desc": "肉盾:高血量", "damageType": "physical", "hp": 500, "crit_rate": 0.1, "crit_dmg": 1.5 },
	"wizard": { "name": "大法师", "icon": "🧙‍♂️", "cost": 50, "size": Vector2i(1,1), "damage": 600, "range": 350, "atkSpeed": 1.2, "foodCost": 10, "manaCost": 50, "attackType": "ranged", "proj": "orb", "splash": 30, "skill": "nova", "skillCd": 12, "desc": "消耗法力高伤\n技能:新星(300💧)", "damageType": "magic", "hp": 150, "crit_rate": 0.1, "crit_dmg": 1.5 },
	...
	"hydra":  { "name": "三头犬", "icon": "🐕", "cost": 120, "size": Vector2i(2,2), "damage": 400, "range": 120, "atkSpeed": 0.8, "foodCost": 200, "manaCost": 0, "attackType": "melee", "skill": "devour_aura", "desc": "2x2巨兽", "damageType": "physical", "hp": 800, "crit_rate": 0.1, "crit_dmg": 1.5 },
	...
	"crystal":{ "name": "法力水晶", "icon": "💎", "cost": 30, "size": Vector2i(1,1), "damage": 0, "range": 0, "atkSpeed": 1.0, "foodCost": 0, "manaCost": -30, "attackType": "none", "produce": "mana", "produceAmt": 30, "desc": "产出:法力+30/s", "hp": 50, "crit_rate": 0.0, "crit_dmg": 1.5 },
	...
	"prism":  { "name": "光之棱镜", "icon": "🧊", "cost": 40, "size": Vector2i(1,1), "damage": 0, "range": 0, "atkSpeed": 0, "foodCost": 0, "manaCost": 0, "attackType": "none", "buffProvider": "range", "desc": "邻接:射程+25%", "hp": 100, "crit_rate": 0.0, "crit_dmg": 1.5 },
	...
	"lens":   { "name": "聚光透镜", "icon": "🔍", "cost": 45, "size": Vector2i(1,1), "damage": 0, "range": 0, "atkSpeed": 0, "foodCost": 0, "manaCost": 0, "attackType": "none", "buffProvider": "crit", "desc": "邻接:暴击率+25%", "hp": 100, "crit_rate": 0.25, "crit_dmg": 1.5 },
	...
	"hedgehog": { "name": "刺猬", "icon": "🦔", "cost": 40, "size": Vector2i(1,1), "damage": 50, "range": 80, "atkSpeed": 1.0, "foodCost": 30, "manaCost": 0, "attackType": "melee", "trait": "reflect", "reflect_percent": 0.3, "desc": "反伤30%", "damageType": "physical", "hp": 400, "crit_rate": 0.0, "crit_dmg": 1.5 },
	"iron_turtle": { "name": "铁甲龟", "icon": "🐢🛡️", "cost": 50, "size": Vector2i(1,1), "damage": 20, "range": 80, "atkSpeed": 0.8, "foodCost": 40, "manaCost": 0, "attackType": "melee", "trait": "flat_reduce", "flat_amount": 20, "desc": "固定减伤20", "damageType": "physical", "hp": 600, "crit_rate": 0.0, "crit_dmg": 1.5 },
	"cow": { "name": "奶牛", "icon": "🐄", "cost": 45, "size": Vector2i(1,1), "damage": 0, "range": 0, "atkSpeed": 1.0, "foodCost": 50, "manaCost": 0, "attackType": "none", "skill": "milk_aura", "desc": "每5秒治疗核心50", "hp": 300, "crit_rate": 0.0, "crit_dmg": 1.5 },
