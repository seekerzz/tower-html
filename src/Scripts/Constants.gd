...
const BARRICADE_TYPES = {
	"mucus": { "hp": 500, "type": "slow", "strength": 0.3, "color": Color("00cec9"), "width": 8, "name": "粘液网", "is_solid": false, "path_weight": 1.0 },
	"poison":{ "hp": 10, "type": "poison", "strength": 200, "color": Color("2ecc71"), "width": 20, "name": "毒雾", "immune": true, "is_solid": false, "path_weight": 1.0 },
	"fang":  { "hp": 800, "type": "reflect", "strength": 100, "color": Color("e74c3c"), "width": 6, "name": "荆棘", "is_solid": false, "path_weight": 1.0 },
	"wood":  { "hp": 2000, "type": "block", "strength": 0, "color": Color("d35400"), "width": 6, "name": "木栏", "is_solid": false, "path_weight": 20.0 },
	"snow":  { "hp": 2000, "type": "freeze", "strength": 1.5, "color": Color("74b9ff"), "width": 8, "name": "冰墙", "is_solid": true, "duration": 20.0, "immune": true, "path_weight": 1.0 },
	"stone": { "hp": 10000, "type": "block", "strength": 0, "color": Color("7f8c8d"), "width": 10, "name": "石墙", "is_solid": true, "immune": true, "path_weight": 1.0 }
}

const UNIT_TYPES = {
	"mouse": { "name": "加特林鼠", "icon": "🐭", "cost": 15, "size": Vector2i(1,1), "damage": 30, "range": 250, "atkSpeed": 0.15, "foodCost": 15, "manaCost": 0, "attackType": "ranged", "proj": "dot", "desc": "远程:超快攻速", "damageType": "physical" },
	"turtle": { "name": "狙击龟", "icon": "🐢", "cost": 25, "size": Vector2i(1,1), "damage": 450, "range": 500, "atkSpeed": 1.8, "foodCost": 80, "manaCost": 0, "attackType": "ranged", "proj": "rocket", "desc": "远程:超远单发", "damageType": "physical" },
	"ranger": { "name": "游侠", "icon": "🤠", "cost": 60, "size": Vector2i(1,1), "damage": 120, "range": 180, "atkSpeed": 1.5, "foodCost": 30, "manaCost": 0, "attackType": "ranged", "proj": "pellet", "projCount": 5, "spread": 0.5, "desc": "霰弹:扇形5发", "damageType": "physical" },
	"ninja": { "name": "忍者", "icon": "🥷", "cost": 80, "size": Vector2i(1,1), "damage": 250, "range": 250, "atkSpeed": 0.8, "foodCost": 40, "manaCost": 0, "attackType": "ranged", "proj": "shuriken", "pierce": 3, "desc": "直线穿透3敌", "damageType": "physical" },
	"tesla": { "name": "磁暴线圈", "icon": "⚡", "cost": 70, "size": Vector2i(1,1), "damage": 350, "range": 200, "atkSpeed": 1.2, "foodCost": 50, "manaCost": 50, "attackType": "ranged", "proj": "lightning", "chain": 4, "desc": "攻击产生闪电链", "damageType": "lightning" },
	"cannon": { "name": "震荡炮", "icon": "💣", "cost": 90, "size": Vector2i(1,1), "damage": 400, "range": 200, "atkSpeed": 2.0, "foodCost": 80, "manaCost": 0, "attackType": "ranged", "proj": "swarm_wave", "desc": "发射腐臭蜂群", "damageType": "poison" },
	"void": { "name": "奇点", "icon": "🌌", "cost": 200, "size": Vector2i(1,1), "damage": 50, "range": 300, "atkSpeed": 3.0, "foodCost": 150, "manaCost": 200, "attackType": "ranged", "proj": "black_hole", "desc": "发射黑洞(停留吸引)", "damageType": "magic" },
	"knight": { "name": "狂战士", "icon": "🗡️", "cost": 30, "size": Vector2i(1,1), "damage": 200, "range": 100, "atkSpeed": 0.8, "foodCost": 40, "manaCost": 0, "attackType": "melee", "splash": 60, "skill": "rage", "skillCd": 10, "desc": "近战:范围挥砍\n技能:血怒(300💧)", "damageType": "physical" },
	"bear":   { "name": "暴怒熊", "icon": "🐻", "cost": 65, "size": Vector2i(1,1), "damage": 350, "range": 80, "atkSpeed": 1.2, "foodCost": 50, "manaCost": 0, "attackType": "melee", "skill": "stun", "skillCd": 15, "desc": "近战:重击晕眩\n技能:震慑(300💧)", "damageType": "physical" },
	"treant": { "name": "树人守卫", "icon": "🌳", "cost": 40, "size": Vector2i(1,1), "damage": 100, "range": 80, "atkSpeed": 1.5, "foodCost": 20, "manaCost": 0, "attackType": "melee", "desc": "肉盾:高血量", "damageType": "physical" },
	"wizard": { "name": "大法师", "icon": "🧙‍♂️", "cost": 50, "size": Vector2i(1,1), "damage": 600, "range": 350, "atkSpeed": 1.2, "foodCost": 10, "manaCost": 50, "attackType": "ranged", "proj": "orb", "splash": 30, "skill": "nova", "skillCd": 12, "desc": "消耗法力高伤\n技能:新星(300💧)", "damageType": "magic" },
	"phoenix":{ "name": "凤凰", "icon": "🦅", "cost": 150, "size": Vector2i(1,1), "damage": 250, "range": 300, "atkSpeed": 0.6, "foodCost": 100, "manaCost": 0, "attackType": "ranged", "proj": "fire", "splash": 40, "skill": "firestorm", "skillCd": 20, "desc": "远程:AOE轰炸\n技能:火雨(300💧)", "damageType": "fire" },
	"hydra":  { "name": "三头犬", "icon": "🐕", "cost": 120, "size": Vector2i(2,2), "damage": 400, "range": 120, "atkSpeed": 0.8, "foodCost": 200, "manaCost": 0, "attackType": "melee", "skill": "devour_aura", "desc": "2x2巨兽", "damageType": "physical" },
	"plant":  { "name": "向日葵", "icon": "🌻", "cost": 20, "size": Vector2i(1,1), "damage": 0, "range": 0, "atkSpeed": 1.0, "foodCost": -60, "manaCost": 0, "attackType": "none", "produce": "food", "produceAmt": 60, "desc": "产出:食物+60/s" },
	"crystal":{ "name": "法力水晶", "icon": "💎", "cost": 30, "size": Vector2i(1,1), "damage": 0, "range": 0, "atkSpeed": 1.0, "foodCost": 0, "manaCost": -30, "attackType": "none", "produce": "mana", "produceAmt": 30, "desc": "产出:法力+30/s" },
