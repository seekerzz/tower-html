...
const UNIT_TYPES = {
	...
	"butterfly": { "name": "蝴蝶", "icon": "🦋", "cost": 50, "size": Vector2i(1,1), "damage": 600, "range": 350, "atkSpeed": 1.2, "foodCost": 10, "manaCost": 50, "attackType": "ranged", "proj": "pollen", "splash": 30, "skill": "nova", "skillCd": 12, "desc": "魔法: 消耗法力释放强力花粉\n技能:新星(300💧)", "damageType": "magic", "hp": 150, "crit_rate": 0.1, "crit_dmg": 1.5 },
